...
_RAW = [
    ...
    "SHOP", "NET", "LYFT",
    # ── Russell 2000 expansion (verified live, float < 100M, May 2026) ────────
    "ALGN", "AORT", "APVO", "ATEX", "AVNS", "BDTX", "BJRI", "BLMN",
    "BLTE", "CARG", "CBRL", "CDXS", "CLDX", "CLRB", "CNTX", "COOK",
    "CRMD", "CSTL", "CYRX", "DNUT", "DRTS", "ALOT", "ALTG", "AMBO",
    "AMCX", "AMTB", "AMTX", "AMWL", "ANGI", "ANGO", "AOUT", "APEI",
    "AQMS", "ARKO", "ARQQ", "ATGL", "ATLC", "ATNI", "ATOM", "ATPC",
    "AUDC", "AVAV", "AVBP", "AVNW", "AVTX", "AXGN", "CLDT", "CLFD",
    "CLIR", "CLOU", "CLPT", "CMCT", "CNGL", "CNOB", "CNTB", "CODA",
    "COFS", "COHN", "CONX", "COYA", "CPBI", "CPSH", "CRBP", "CRCT",
    "EVTV", "GNRC", "STEM", "WKHS",
    # ── R2000 expansion v2 (stocks only, verified May 2026) ──────────────────
    "AAAC", "AACB", "AACI", "AACO", "AAME", "AARD", "AAT", "ABEO",
    "ABOS", "ABXL", "ACAA", "ACB", "ACCO", "ACCS", "ACDC", "ACEI",
    "ACEL", "ACET", "ACFN", "ACH", "ACHV", "ACIC", "ACII", "ACKY",
    "ACNT", "ACOG", "ACON", "ACRE", "ACTG", "ACTS", "ACV", "ACYN",
    "ADAC", "ADAG", "ADAM", "ADAMG", "ADAMH", "ADAMI", "ADAML", "ADAMM",
    "ADAMN", "ADAMO", "ADIL", "ADNT", "ADSE", "ADTN", "ADV", "ADVB",
    "ADXN", "AEAQ", "AEBI", "AEC", "AEF", "AEFC", "AEHL", "AEMD",
    "AENT", "AEXA", "AFB", "AFBI", "AFCG", "AFGB", "AFGC", "AFGD",
    "AFGE", "AFJK", "AFRI", "AFYA", "AGBK", "AGCC", "AGD", "AGIQ",
    "AGMB", "AGNT", "AGRO", "AHCO", "AHRT", "AHT", "AIAI", "AII",
    "AIIA", "AIIO", "AINT", "AIO", "AIOS", "AIRE", "AIRG", "AIRI",
    "AIRJ", "AIRO", "AIRS", "AIRT", "AIZN", "AKA", "AKTS", "ALCO",
    "ALDF", "ALF", "ALIS", "ALKT", "ALOV", "ALOY", "ALRS", "ALTI",
    "ALTO", "ALUB", "AMAL", "AMAN", "AMCI", "AMLX", "AMN", "AMPG",
    "AMPL", "AMPY", "AMRC", "AMSF", "AMWD", "ANIX", "ANL", "ANNA",
    "ANPA", "ANRO", "ANSC", "ANTA", "ANTX", "ANVS", "AOMD", "AOMN",
    "AOSL", "AOTS", "APAC", "APC", "APLM", "APOG", "APOS", "APPN",
    "APT", "APXT", "APYX", "AQNB", "ARBB", "ARBK", "ARCI", "ARDC",
    "ARDT", "ARHS", "ARL", "ARMY", "ARQ", "ARTC", "ARTNA", "ARTV",
    "ASAN", "ASBA", "ASC", "ASG", "ASGI", "ASIC", "ASIX", "ASLE",
    "ASMB", "ASPC", "ASPI", "ASPN", "ASPS", "ASRV", "ASST", "ASTC",
    "ASTE", "ASTI", "ASTL", "ASYS", "ATC", "ATCL", "ATCX", "ATHS",
    "ATII", "ATLCL", "ATLO", "ATLX", "ATRA", "AUBN", "AUC", "AUNA",
    "AURA", "AURE", "AVAH", "AVBC", "AVBH", "AVD", "AVEX", "AVK",
    "AVLN", "AVO", "AWF", "AWX", "AXG", "AXIL", "AXIN", "BACC",
    "BAFN", "BALY", "BANX", "BAOS", "BATL", "BAVA", "BAYA", "BBBY",
    "BBCQ", "BBGI", "BBN", "BBNX", "BBOT", "BBSI", "BCAL", "BCAX",
    "BCEM", "BCHG", "BCIC", "BCML", "BCSF", "BCSS", "BCTX", "BCV",
    "BCX", "BDCI", "BDL", "BDSX", "BEAG", "BEBE", "BENF", "BEPH",
    "BEPI", "BEPJ", "BESO", "BESS",
]
